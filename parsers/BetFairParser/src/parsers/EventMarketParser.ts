...
import { IEventMarket, BetFair, ISelection } from "../betfair";
...
export class EventMarketParser extends ParserBase {
    ...
    async processRequest(market: IEventMarket) {
        ...
        let selections = await BetFair.getMarketSelections(market.sp_market_id);
    ...
    private parseSelections(selections: ISelection[], participants: IFeedParticipant[]): ISelection[] {
    ...
    private async parseMarket(market: IEventMarket) {
