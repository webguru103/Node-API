exports.up = function (knex, Promise) {
    return knex.schema.createTable('market_mapping', function (t) {
        ...
        t.integer('system_market_id').nullable();
        t.foreign('provider_id').references('provider.id');
    }).then(() => {
        return knex.raw("create unique index market_mapping_idx on market_mapping(provider_id, provider_market_id, provider_category_id)");
