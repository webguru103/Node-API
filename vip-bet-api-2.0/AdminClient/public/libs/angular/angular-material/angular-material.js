...
function InterimElementProvider() {
  ...
  function createInterimElementProvider(interimFactoryName) {
    ...
    /**
     * Save the configured displayGroups to be used when the factory is instantiated
     */
    ...
    /**
     * Create a factory that has the given methods & displayGroups implementing interimElement
     */
    /* @ngInject */
...
(function() {
   ...
   *   <md-fab-trigger>
   *     <md-button aria-label="Add..."><md-icon icon="/src/img/icons/plus.svg"></md-icon></md-button>
   *   </md-fab-trigger>
   *
   *   <md-fab-actions>
   *     <md-button aria-label="Add User">
   *       <md-icon icon="/src/img/icons/user.svg"></md-icon>
   *     </md-button>
   *
   *     <md-button aria-label="Add Group">
   *       <md-icon icon="/src/img/icons/group.svg"></md-icon>
   *     </md-button>
   *   </md-fab-actions>
   * </md-fab-speed-dial>
   * </hljs>
 ...
 *      $mdIconProvider
 *         .iconSet('social', 'src/img/icons/sets/social-icons.svg', 24)
 *         .defaultIconSet('src/img/icons/sets/core-icons.svg', 24);
 *     });
 * </hljs>
 *
 *
...
"use strict";
  ...
  /**
    ...
    *
    *     var urls = [ 'imy/app/icons.svg', 'src/img/icons/android.svg'];
    *
  ...
  *
  *   $mdIcon('src/img/icons/android.svg').then(function(iconEl) {
...
function MenuProvider($$interimElementProvider) {
  ...
  function menuDefaultOptions($$rAF, $window, $mdUtil, $mdTheming, $timeout, $mdConstant, $document) {
    ...
    function onShow(scope, element, opts) {
      ...
      // Sanitize and set displayGroups on opts
      buildOpts(opts);
      ...
      /** Check for valid opts and set some sane displayGroups */
      function buildOpts() {
        if (!opts.target) {
          throw Error(
 ...
 *     Play Music
 *   </md-tooltip>
 *   <md-icon icon="src/img/icons/ic_play_arrow_24px.svg"></md-icon>
 * </md-button>
 * </hljs>
 *
 ...
 *   <img ng-src="src/img/angular.png" class="centered">
 *   <md-tab
 ...
 *     <md-tab-label>
 *       {{tab.title}}
 *       <img src="src/img/removeTab.png" ng-click="removeTab(tab)" class="delete">
 *     </md-tab-label>
 *     <md-tab-body>
 *       {{tab.content}}
 *     </md-tab-body>
