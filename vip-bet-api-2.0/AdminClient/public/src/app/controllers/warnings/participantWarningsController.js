...
(function () {
    angular
        .module("app")
        .controller("participantWarningsController", participantWarningsController);

    participantWarningsController.$inject = ['$scope', 'warningService', 'warningType', 'toastr'];

    function participantWarningsController($scope, warningService, warningType, toastr) {
        var type = warningType.participant;
