...
class Server {
    ...
    private initDB() {
        ...
        const db = CONF.Databases.FeedBetAtHome.postgres;
        ...
        ServiceBase.providerId = ProviderID.BET_AT_HOME;
    }
    ...
    private async initBroker() {
        ...
        const callbackQueue = QueueType.BET_AT_HOME_PARSER_SERVICE + "-" + uuid.v4();
