app.controller('MDAutocompleteCtrl', function($scope, $timeout, $q) {
  ...
  function loadAll() {
    var allStates = 'Alabama, Alaska, Arizona, Arkansas, California, Colorado, Connecticut, Delaware,\
            Florida,  a, Hawaii, Idaho, Illinois, Indiana, Iowa, Kansas, Kentucky, Louisiana,\
...
app.controller('MDDialogCtrl', function($scope, $mdDialog) {
  ...
  $scope.showAdvanced = function(ev) {
    $mdDialog.show({
      ...
      templateUrl: 'src/tpl/material/dialog.tmpl.html',
      targetEvent: ev,
    })
...
app.controller('MDToastCtrl', function($scope, $mdToast, $animate) {
  ...
  $scope.showCustomToast = function() {
    $mdToast.show({
      ...
      templateUrl: 'src/tpl/material/toast.tmpl.html',
      hideDelay: 6000,
      parent:'#toast',
