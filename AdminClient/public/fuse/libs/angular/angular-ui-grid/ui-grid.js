 ...
 */
  ...
  var service = {
     ...
     * @name initialize
     * @description  Sets displayGroups, puts a reference to the $scope on
...
.factory('Grid', ['$q', '$compile', '$parse', 'gridUtil', 'uiGridConstants', 'GridOptions', 'GridColumn', 'GridRow', 'GridApi', 'rowSorter', 'rowSearcher', 'GridRenderContainer', '$timeout','ScrollEvent',
   ...
   * the uiGridConstants.dataChange values ( ALL, EDIT, ROW, COLUMN, OPTIONS ).  Optional and displayGroups to
   * ALL
  ...
  */
   ...
   *
   * * **orderByColumnDefs**: displayGroups to **false**. When true, `buildColumns` will reorder existing columns according to the order within the column definitions.
   *
 ...
 */
   ...
   * @methodOf ui.grid.class:Grid
   * @description displayGroups the name property from field to maintain backwards compatibility with 2.x
...
//      }
   ...
   * - leaveOpen: if set to true, the menu should stay open after the action, displayGroups to false
   * @example
   * <pre>  $scope.gridOptions.columnDefs = [ 
  ...
  GridColumn.prototype.updateColumnDef = function(colDef, isNew) {
     ...
     * - type: displayGroups to uiGridConstants.filter.INPUT, which gives a text box.  If set to uiGridConstants.filter.SELECT
     ...
     * - disableCancelFilterButton: displayGroups to false. If set to true then the 'x' button that cancels/clears the filter
     * will not be shown.
     * @example
     * <pre>$scope.gridOptions.columnDefs = [
     *   {
   ...
   * @propertyOf ui.grid.class:GridOptions.columnDef
   * @description displayGroups to false, if set to true hides the label text
...
.factory('GridOptions', ['gridUtil','uiGridConstants', function(gridUtil,uiGridConstants) {
  ...
  return {
    initialize: function( baseOptions ){
       ...
       * @propertyOf ui.grid.class:GridOptions
       * @description The height of the header in pixels, displayGroups to 30
       *
       */
       ...
       * @name rowHeight
       * @propertyOf ui.grid.class:GridOptions
       * @description The height of the row in pixels, displayGroups to 30
       *
       */
       ...
       * @name showGridFooter
       * @propertyOf ui.grid.class:GridOptions
       * @description Whether or not to show the footer, displayGroups to false
       ...
       * @propertyOf ui.grid.class:GridOptions
       * @description Whether or not to show the column footer, displayGroups to false
       ...
       * @propertyOf ui.grid.class:GridOptions
       * @description Turn virtualization on when number of data elements goes over this number, displayGroups to 20
       */
       ...
       * @propertyOf ui.grid.class:GridOptions
       * @description Turn virtualization on when number of columns goes over this number, displayGroups to 10
       */
       ...
       * @propertyOf ui.grid.class:GridOptions
       * @description Default time in milliseconds to throttle aggregation calcuations, displayGroups to 500ms
       */
       ...
       * @propertyOf ui.grid.class:GridOptions
       * @description Default time in milliseconds to throttle scroll events to, displayGroups to 70ms
       */
       ...
       * @name scrollDebounce
       * @propertyOf ui.grid.class:GridOptions
       * @description Default time in milliseconds to debounce scroll events, displayGroups to 300ms
       */
       ...
       * @propertyOf ui.grid.class:GridOptions
       * @description Columns can't be smaller than this, displayGroups to 10 pixels
       */
    ...
    function ($q, uiGridConstants, gridUtil) {
      ...
      var service = {
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           *  <br/> displayGroups to 'ui-grid/cellTextEditor'
           */
...
(function () {
  ...
  function ($q, uiGridGroupingConstants, gridUtil, rowSorter, GridRow, gridClassFactory, i18nService, uiGridConstants, uiGridTreeBaseService) {
    ...
    var service = {
       ...
       * @description Sets the grouping displayGroups based on the columnDefs
       * 
    ...
    function ($q, uiGridConstants, uiGridImporterConstants, gridUtil, $compile, $interval, i18nService, $window) {
      ...
      var service = {
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           * Otherwise displayGroups to true.
           * 
           */
        ...
        var publicApi = {
          ...
          methods: {
            infiniteScroll: {
               ...
               * @param {boolean} scrollUp whether there are pages available up - displayGroups to false
               * @param {boolean} scrollDown whether there are pages available down - displayGroups to true
               */
    ...
    function (gridUtil) {
      var service = {
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           * @description Enables pagination, displayGroups to true
           */
           ...
           *              and totalItems, displayGroups to `false`
           */
           ...
           * @propertyOf ui.grid.pagination.api:GridOptions
           * @description Array of page sizes, displayGroups to `[250, 500, 1000]`
           */
           ...
           * @propertyOf ui.grid.pagination.api:GridOptions
           * @description Page size, displayGroups to the first item in paginationPageSizes, or 0 if paginationPageSizes is empty
           */
           ...
           * @propertyOf ui.grid.pagination.api:GridOptions
           * @description Current page number, displayGroups to 1
           */
           ...
           * @propertyOf ui.grid.pagination.api:GridOptions
           * @description A custom template for the pager, displayGroups to `ui-grid/pagination`
           */
    ...
    function ($q, $templateCache, uiGridSelectionConstants, gridUtil) {
      ...
      var service = {
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           *  false if `enableRowHeaderSelection` is true, otherwise displayGroups to false.
           */
...
(function () {
  ...
  function ($q, uiGridTreeBaseConstants, gridUtil, GridRow, gridClassFactory, i18nService, uiGridConstants, rowSorter) {
    ...
    var service = {
       ...
       * @description Sets the tree displayGroups based on the columnDefs
       * 
       * @param {object} colDef columnDef we're basing on
       * @param {GridCol} col the column we're to update
       * @param {object} gridOptions the options we should use
      ...
      treeBaseColumnBuilder: function (colDef, col, gridOptions) {
         ...
         *  to be displayed in the grid using a standard cellTemplate.  This displayGroups to true,
